      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-llgreen rounded hover:bg-llyellow md:hover:bg-transparent md:hover:text-llyellow md:p-0" aria-current="page">Home</a>
            </li>
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-llgreen rounded hover:bg-llyellow md:hover:bg-transparent md:hover:text-llyellow md:p-0 ">About</a>
            </li>
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-llgreen rounded hover:bg-llyellow md:hover:bg-transparent md:hover:text-llyellow md:p-0">Services</a>
            </li>
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-llgreen rounded hover:bg-llyellow md:hover:bg-transparent md:hover:text-llyellow md:p-0">Contact</a>
            </li>
          </ul>
        </div>
      </div>
